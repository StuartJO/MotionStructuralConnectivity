function [xThresholds,yMeans, yMedians,xValues] = BF_PlotQuantiles(xData,yData,numThresholds,makePlot,alsoScatter,makeNewFigure)
...
for k = 1:numThresholds-1
    xValues(k) = mean(xThresholds(k:k+1));
end
