function QCSCvsEdgeConLenWei2(QCSC_DATA,LENGTH_DATA,CONSISTENCY_DATA,WEIGHT_DATA,PipelineLabels)
% INPUTS:
%
...
scatter(log(WEIGHT_DATA{i}),QCSC_DATA{i},10,LENGTH_DATA{i},'filled')
...
scatter(log(WEIGHT_DATA{i}),QCSC_DATA{i},10,CONSISTENCY_DATA{i},'filled')
xlabel('Edge weight (log)')
ylabel('QC-SC correlation')
c = colorbar;
